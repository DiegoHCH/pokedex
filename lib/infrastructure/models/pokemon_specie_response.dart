...
class PokemonSpecieResponse {
    ...
    factory PokemonSpecieResponse.fromJson(Map<String, dynamic> json) => PokemonSpecieResponse(
        ...
        name: json["name"],
        names: List<SpecieName>.from(json["names"].map((x) => SpecieName.fromJson(x))),
        order: json["order"],
...
class SpecieName {
    ...
    factory SpecieName.fromJson(Map<String, dynamic> json) => SpecieName(
        language: Color.fromJson(json["language"]),
        name: json["name"],
    );
